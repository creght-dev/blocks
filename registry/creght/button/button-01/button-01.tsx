...
export function Button01({
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -inset-[150%] z-0 animate-spin bg-[conic-gradient(from_0deg,transparent_0deg_230deg,rgba(77,151,255,0.08)_250deg,rgba(106,172,255,0.7)_276deg,rgba(232,248,255,1)_302deg,rgba(89,157,255,0.82)_326deg,transparent_350deg_360deg)] [animation-duration:2.8s] motion-reduce:animate-none group-disabled:opacity-45 group-disabled:[animation-play-state:paused]"
      />
      <span
        aria-hidden="true"
        className="pointer-events-none absolute inset-px z-[1] rounded-[inherit] bg-[radial-gradient(circle_at_72%_-20%,rgba(112,172,255,0.16),transparent_48%),linear-gradient(105deg,#394f7d_0%,#17458f_48%,#0d4db5_100%)]"
      />
