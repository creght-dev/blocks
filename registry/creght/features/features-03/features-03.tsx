        ...
        <div className="flex min-w-0 items-center justify-center lg:pl-2">
          <div className="relative aspect-[16/10] w-full max-w-[980px] overflow-hidden rounded-[26px] border border-white/12 bg-black/20 shadow-[0_35px_100px_rgba(0,0,0,0.45)]">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="absolute right-4 top-4 rounded-full border border-white/12 bg-black/25 px-3 py-1.5 text-[9px] font-medium tracking-[0.12em] text-white/52 backdrop-blur-md transition hover:bg-black/40 hover:text-white/82 sm:right-6 sm:top-6"
            >
              PHOTO / UNSPLASH
            </a>
          </div>
