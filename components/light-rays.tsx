...
export default function Rays({
  ...
  }, [color1RGB, color2RGB, intensity, isMounted, position, rays, reach]);
      ...
      {webglFailed ? (
        <div
          ...
          style={{
            ...
            inset: 0,
            background: `
              linear-gradient(104deg, transparent 0%, transparent 34%, ${fallbackColor}32 44%, transparent 58%),
              linear-gradient(78deg, transparent 0%, transparent 37%, ${fallbackColor}2b 48%, transparent 64%),
              linear-gradient(94deg, transparent 0%, transparent 45%, ${fallbackColor}3d 51%, transparent 60%),
              radial-gradient(circle at ${position}% -12%, ${fallbackColor}8a 0%, ${fallbackColor}34 30%, transparent 58%),
              conic-gradient(from 205deg at ${position}% -18%, transparent 0deg, ${fallbackColor}40 20deg, transparent 38deg, transparent 58deg, ${fallbackColor}36 78deg, transparent 106deg),
              linear-gradient(${backgroundColor}, ${backgroundColor})
            `,
            filter: "blur(0.3px)",
            opacity: Math.min(1, Math.max(0.35, intensity / 36)),
          }}
        />
      ) : null}
    </div>
